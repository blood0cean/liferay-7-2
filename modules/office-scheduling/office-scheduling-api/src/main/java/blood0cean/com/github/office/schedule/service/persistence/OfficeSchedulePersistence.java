...
/**
 * The persistence interface for the office schedule service.
 *
 * <p>
 ...
 *
 * @author Blood 0cean
 * @see OfficeScheduleUtil
 * @generated
 */
@ProviderType
public interface OfficeSchedulePersistence
	extends BasePersistence<OfficeSchedule> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OfficeScheduleUtil} to access the office schedule persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<OfficeSchedule> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<OfficeSchedule> findByUuid(
	...
	public java.util.List<OfficeSchedule> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OfficeSchedule>
			orderByComparator);
	 ...
	 * @return the matching office schedules
	 */
	public java.util.List<OfficeSchedule> findByUuid_C(
	 ...
	 */
	public void cacheResult(java.util.List<OfficeSchedule> officeSchedules);
	 ...
	 */
	public java.util.List<OfficeSchedule> findAll();
	 ...
	 */
	public java.util.List<OfficeSchedule> findAll(int start, int end);
