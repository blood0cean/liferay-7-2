...
/**
 * Provides the local service interface for OfficeSchedule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Blood 0cean
 * @see OfficeScheduleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OfficeScheduleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OfficeScheduleLocalServiceUtil} to access the office schedule local service. Add custom service methods to <code>blood0cean.com.github.office.schedule.service.impl.OfficeScheduleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
